<?php
//endpoint that handles sending out a list of all devices (both active and inactive)
try{
...
//tries to query the database for list of all devices, if it fails it sends out the written error message
try{
